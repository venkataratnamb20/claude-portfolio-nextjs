...
export default function Footer() {
  ...
  return (
    <footer
      className="border-t"
      style={{ borderColor: 'var(--border)', background: 'rgba(10,10,15,0.95)' }}
    >
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-text-muted text-sm leading-relaxed max-w-xs">
              Senior AI/ML Architect & Principal AI Scientist. Building the future of intelligent systems.
            </p>
          </div>

          {/* Quick links */}
          <div>
            <h4 className="font-display font-semibold text-text mb-4 text-sm tracking-wide">
              Navigation
            </h4>
        ...
        >
          <p className="text-muted text-sm font-mono">
            © {currentYear} John Doe. Built with Next.js & Tailwind CSS.
          </p>
